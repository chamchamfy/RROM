.class public final Landroid/preference/DICCHelper;
...
.method public static DynamicIsland()Z
    ...
    invoke-static {v0, v1}, Landroid/preference/DICCHelper;->getIntofSettings(Ljava/lang/String;I)I
...
.method public static DynamicIslandBool()I
    ...
    invoke-static {}, Landroid/preference/DICCHelper;->IosDynamicIsland()Z
    ...
    invoke-static {v0}, Landroid/preference/DICCHelper;->getIdentifier(Ljava/lang/String;)I
...
.method public static getAnimId(I)I
    ...
    invoke-static {v4}, Landroid/preference/DICCHelper;->getStringofSettings(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Landroid/preference/DICCHelper;->getCon()Landroid/content/Context;
...
.method public static getBoolofSettings(Ljava/lang/String;)Z
    ...
    invoke-static {}, Landroid/preference/DICCHelper;->getCR()Landroid/content/ContentResolver;
...
.method private static getCR()Landroid/content/ContentResolver;
    ...
    sget-object v0, Landroid/preference/DICCHelper;->sCR:Landroid/content/ContentResolver;
    ...
    sput-object v0, Landroid/preference/DICCHelper;->sCR:Landroid/content/ContentResolver;
...
.method public static getCon()Landroid/content/Context;
    ...
    sget-object v0, Landroid/preference/DICCHelper;->sCon:Landroid/content/Context;

    if-nez v0, :cond_a

    invoke-static {}, Landroid/preference/DICCHelper;->createContext()Landroid/content/Context;

    move-result-object v0

    sput-object v0, Landroid/preference/DICCHelper;->sCon:Landroid/content/Context;
